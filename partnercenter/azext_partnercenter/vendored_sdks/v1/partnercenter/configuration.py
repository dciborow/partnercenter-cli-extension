...
class Configuration(object):
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://api.partner.microsoft.com/v1.0/ingestion" if host is None else host
        """Default Base url
        """
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: v1".format(env=sys.platform, pyversion=sys.version)
        )
