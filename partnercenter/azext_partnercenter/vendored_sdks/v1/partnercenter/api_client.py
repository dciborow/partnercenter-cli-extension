...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None, pool_threads=1):
        ...
        self.user_agent = "OpenAPI-Generator/v1/python"
        ...
        for param_name, file_instances in files.items():
            ...
            for file_instance in file_instances:
                ...
                if file_instance.closed is True:
                    raise ApiValueError(
                        f"Cannot read a closed file. The passed in file_type for {param_name} must be open."
                    )
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BranchesClient()
        api_instance.products_product_id_branches_get_by_module_modulemodule_get  # this is an instance of the class Endpoint
        api_instance.products_product_id_branches_get_by_module_modulemodule_get()  # this invokes api_instance.products_product_id_branches_get_by_module_modulemodule_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.products_product_id_branches_get_by_module_modulemodule_get.callable or self.callable in this class
    ...
    def call_with_http_info(self, **kwargs):
        ...
        if kwargs.get("_content_type"):
            ...
            if params["body"] != "":
                if content_types_list := self.api_client.select_header_content_type(
