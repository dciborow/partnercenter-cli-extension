...
class ListingAssetClient(object):
    ...
    def products_product_id_listings_listing_id_assets_asset_id_put(
        ...
        **kwargs
        ...
        >>> thread = api.products_product_id_listings_listing_id_assets_asset_id_put(product_id, listing_id, asset_id, authorization, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            client_request_id (str): ID of request provIDed by user. [optional]
            microsoft_ingestion_api_models_listings_listing_asset (MicrosoftIngestionApiModelsListingsListingAsset): Request body of a Microsoft.Ingestion.Api.Models.Listings.ListingAsset. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def products_product_id_listings_listing_id_assets_post(
        ...
        **kwargs
        ...
        >>> thread = api.products_product_id_listings_listing_id_assets_post(product_id, listing_id, authorization, async_req=True)
        >>> result = thread.get()
