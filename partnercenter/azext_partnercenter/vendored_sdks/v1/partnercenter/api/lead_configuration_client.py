...
class LeadConfigurationClient(object):
    ...
    def products_product_id_leadconfiguration_post(self, product_id, authorization, **kwargs):
        ...
        >>> thread = api.products_product_id_leadconfiguration_post(product_id, authorization, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            client_request_id (str): ID of request provIDed by user. [optional]
            products_product_id_leadconfiguration_get200_response (ProductsProductIDLeadconfigurationGet200Response): Request body of a Microsoft.Ingestion.Api.Models.LeadManagement.BaseLeadConfiguration. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
