...
class MicrosoftIngestionApiModelsSubmissionsWorkflowStepDetail(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):    # noqa: E501
        """MicrosoftIngestionApiModelsSubmissionsWorkflowStepDetail - a model defined in OpenAPI
