...
class MicrosoftIngestionApiModelsSubmissionsVariantResource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):    # noqa: E501
        """MicrosoftIngestionApiModelsSubmissionsVariantResource - a model defined in OpenAPI
