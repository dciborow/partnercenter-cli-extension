...
class MicrosoftIngestionApiModelsAvailabilitiesAudienceMember(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):    # noqa: E501
        """MicrosoftIngestionApiModelsAvailabilitiesAudienceMember - a model defined in OpenAPI
